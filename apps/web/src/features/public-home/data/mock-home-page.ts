...
export const mockHomePage = {
    ...
    blocks: [
        // Hero Overlapping Block
        {
            ...
            description: "Make a difference for your favorite nonprofit by starting a onlydonations for your birthday, a marathon, or just because you care.",
            ...
            items: [
                {
                    ...
                    description: "In your fundraising description, share why you are fundraising for the charity. Researching the charity's website for a quick mission statement or to explain how they live out their cause is also helpful for potential donors.",
                },
                {
                    id: "tip-2",
                    iconName: "calendar",
                    title: "Use events or moments",
                    description: "One way to help drive donations is to tie your cause back to a timely moment or event. Whether it's breast cancer awareness month, an upcoming marathon, a birthday, or a random Tuesday that you want to make special, share the date so people can get excited.",
                },
                {
                    id: "tip-3",
                    iconName: "heart",
                    title: "Thank and update donors",
                    description: "Easily keep donors updated about the campaign's progress and thank them for their support. Simple gestures like personalized thank you notes with an ask for additional help in sharing your cause with their networks is easy but powerful.",
                },
                {
                    id: "tip-4",
                    iconName: "share",
                    title: "Spread the word",
                    description: "Share your fundraiser across social media platforms and encourage friends and family to do the same. The more people who see your campaign, the more likely you are to reach your goal and make a meaningful impact.",
                },
            ],
        },

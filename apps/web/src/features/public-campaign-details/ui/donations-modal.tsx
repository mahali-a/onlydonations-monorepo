          ...
          <Tabs defaultValue="newest" className="w-full h-full flex flex-col">
            <div className="px-4 py-2 shrink-0">
              <TabsList className="w-fit bg-transparent p-0 gap-4 border-none">
                <TabsTrigger
                  value="newest"
                  className="px-4 data-[state=active]:text-primary-foreground data-[state=inactive]:bg-transparent data-[state=inactive]:text-muted-foreground border-b border-transparent data-[state=inactive]:hover:bg-muted"
                >
                  Newest
                </TabsTrigger>
                <TabsTrigger

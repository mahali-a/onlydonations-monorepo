    ...
    return (
        <div className="w-full border-b bg-white sticky top-0 z-10 transition-shadow duration-200">
            <div className="container mx-auto px-4 py-3 flex items-center relative h-14">
                ...
                <div
                    className={`absolute left-1/2 -translate-x-1/2 w-full max-w-md transition-all duration-300 ease-in-out z-10 ${isScrolled ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"
                        }`}
                >
                    {isScrolled && (

        ...
        <form onSubmit={handleSearch} className="w-full max-w-[600px] relative mb-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-[50px] pl-12 pr-24 rounded-full border-none bg-muted/70 focus:ring-0 transition-colors text-base placeholder:text-muted-foreground/50"
            />
            <Button
              type="submit"

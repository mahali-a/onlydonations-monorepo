...
export function HowItWorksSection({ title, ctaText, onCtaClick }: HowItWorksSectionProps) {
    return (
        <section className="bg-white py-20">
            <nav className="flex justify-center pb-8">
                <div className="flex items-center gap-6 text-sm font-medium text-gray-600">
                    <button
                        type="button"
                        className="bg-[#2a2e30] text-white px-4 py-2 rounded-full"
                    >
                        How to start
                    </button>
            ...
            <main className="max-w-7xl mx-auto px-4 py-12">
                <h2 className="text-4xl font-bold text-center mb-16 text-[#2a2e30]">
                    {title}
                </h2>

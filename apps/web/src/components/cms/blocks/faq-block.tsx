  ...
  return (
    <section className="bg-white py-20">
      <div className="max-w-[1250px] mx-auto px-6 lg:px-12">
        {block.title && (
          <h2 className="text-4xl md:text-5xl font-bold mb-16 tracking-tight">{block.title}</h2>
        )}
...
function FaqAccordionItem({ faq }: { faq: { id: string; question: string; answer: string } }) {
  ...
  return (
    <div className="border-b border-gray-200">
      ...
      >
        <span className="text-xl md:text-2xl font-bold flex-1">{faq.question}</span>
